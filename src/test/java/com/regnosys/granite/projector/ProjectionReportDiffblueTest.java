...
public class ProjectionReportDiffblueTest {
  ...
  public void testIsSuccess() {
    ...
    BarBuilder barBuilder = new BarBuilder();
    BarBuilder resultObject = new BarBuilder();
    ProjectionReport<RosettaModelObject, Object> projectionReport = new ProjectionReport<>(barBuilder, null, null,
        InputValidationReport.SUCCESS, new ValidationReport(resultObject, new ArrayList<>()));
