...
class ConstantAttributePropertyWriterDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given construct {@code ALWAYS} and {@code ALWAYS}.
   * </ul>
   *
  ...
  @Test
  @DisplayName(
      "Test new ConstantAttributePropertyWriter(String, BeanPropertyDefinition, Annotations, JavaType, String); given construct 'ALWAYS' and 'ALWAYS'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ConstantAttributePropertyWriter.<init>(String, BeanPropertyDefinition, Annotations, JavaType, String)"
  })
  void testNewConstantAttributePropertyWriter_givenConstructAlwaysAndAlways() {
    // Arrange
   ...
   *
   * <ul>
   *   <li>Given construct {@code NON_ABSENT} and {@code ALWAYS}.
   * </ul>
   *
   * <p>Method under test: {@link
   * ConstantAttributePropertyWriter#ConstantAttributePropertyWriter(String, BeanPropertyDefinition,
  ...
  @Test
  @DisplayName(
      "Test new ConstantAttributePropertyWriter(String, BeanPropertyDefinition, Annotations, JavaType, String); given construct 'NON_ABSENT' and 'ALWAYS'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ConstantAttributePropertyWriter.<init>(String, BeanPropertyDefinition, Annotations, JavaType, String)"
  })
  void testNewConstantAttributePropertyWriter_givenConstructNonAbsentAndAlways() {
    // Arrange
    SimpleBeanPropertyDefinition propDef = mock(SimpleBeanPropertyDefinition.class);
    PropertyName constructResult = PropertyName.construct("Simple Name");
    when(propDef.getWrapperName()).thenReturn(constructResult);
   ...
   *
   * <ul>
   *   <li>Given construct {@code NON_NULL} and {@code ALWAYS}.
   * </ul>
   *
   * <p>Method under test: {@link
   * ConstantAttributePropertyWriter#ConstantAttributePropertyWriter(String, BeanPropertyDefinition,
  ...
  @Test
  @DisplayName(
      "Test new ConstantAttributePropertyWriter(String, BeanPropertyDefinition, Annotations, JavaType, String); given construct 'NON_NULL' and 'ALWAYS'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ConstantAttributePropertyWriter.<init>(String, BeanPropertyDefinition, Annotations, JavaType, String)"
  })
  void testNewConstantAttributePropertyWriter_givenConstructNonNullAndAlways() {
    // Arrange
    SimpleBeanPropertyDefinition propDef = mock(SimpleBeanPropertyDefinition.class);
    PropertyName constructResult = PropertyName.construct("Simple Name");
    when(propDef.getWrapperName()).thenReturn(constructResult);
  ...
  @Test
  @DisplayName(
      "Test new ConstantAttributePropertyWriter(String, BeanPropertyDefinition, Annotations, JavaType, String); given empty")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ConstantAttributePropertyWriter.<init>(String, BeanPropertyDefinition, Annotations, JavaType, String)"
  })
  void testNewConstantAttributePropertyWriter_givenEmpty() {
    // Arrange
    SimpleBeanPropertyDefinition propDef = mock(SimpleBeanPropertyDefinition.class);
    PropertyName constructResult = PropertyName.construct("Simple Name");
    when(propDef.getWrapperName()).thenReturn(constructResult);
  ...
  @Test
  @DisplayName(
      "Test new ConstantAttributePropertyWriter(String, BeanPropertyDefinition, Annotations, JavaType, String); given 'null'")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void ConstantAttributePropertyWriter.<init>(String, BeanPropertyDefinition, Annotations, JavaType, String)"
  })
  void testNewConstantAttributePropertyWriter_givenNull() {
    // Arrange
    SimpleBeanPropertyDefinition propDef = mock(SimpleBeanPropertyDefinition.class);
    PropertyName constructResult = PropertyName.construct("Simple Name");
    when(propDef.getWrapperName()).thenReturn(constructResult);
