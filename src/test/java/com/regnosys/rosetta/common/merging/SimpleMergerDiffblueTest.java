...
class SimpleMergerDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link SimpleMerger#SimpleMerger()}.
   *   <li>When {@link BarBuilder} (default constructor).
  ...
  @Test
  @DisplayName(
      "Test run(RosettaModelObjectBuilder, RosettaModelObjectBuilder); given SimpleMerger(); when BarBuilder (default constructor); then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void SimpleMerger.run(RosettaModelObjectBuilder, RosettaModelObjectBuilder)"})
  void testRun_givenSimpleMerger_whenBarBuilder_thenDoesNotThrow() {
    // Arrange
    SimpleMerger simpleMerger = new SimpleMerger();
    BarBuilder barBuilder = new BarBuilder();

    // Act and Assert
    assertDoesNotThrow(() -> simpleMerger.run(barBuilder, new BarBuilder()));
  }
  ...
  @Test
  @DisplayName(
      "Test mergeRosetta(List, List, Function) with 'o1', 'o2', 'o1GetOrCreateByIndex'; when Function; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void SimpleMerger.mergeRosetta(List, List, Function)"})
  void testMergeRosettaWithO1O2O1GetOrCreateByIndex_whenFunction_thenDoesNotThrow() {
    // Arrange
    SimpleMerger simpleMerger = new SimpleMerger();
    ArrayList<RosettaModelObjectBuilder> o1 = new ArrayList<>();
    ...
    // Act and Assert
    assertDoesNotThrow(
        () -> simpleMerger.mergeRosetta(o1, new ArrayList<>(), mock(Function.class)));
  }
  ...
  @Test
  @DisplayName(
      "Test mergeRosetta(RosettaModelObjectBuilder, RosettaModelObjectBuilder, Consumer) with 'o1', 'o2', 'o1Setter'; given ten; when BarBuilder (default constructor) Num is ten")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void SimpleMerger.mergeRosetta(RosettaModelObjectBuilder, RosettaModelObjectBuilder, Consumer)"
  })
  void testMergeRosettaWithO1O2O1Setter_givenTen_whenBarBuilderNumIsTen() {
    // Arrange
    SimpleMerger simpleMerger = new SimpleMerger();
    ...
    // Act and Assert
    assertDoesNotThrow(
        () -> simpleMerger.mergeRosetta(barBuilder, new BarBuilder(), mock(Consumer.class)));
  }
  ...
  @Test
  @DisplayName(
      "Test mergeRosetta(RosettaModelObjectBuilder, RosettaModelObjectBuilder, Consumer) with 'o1', 'o2', 'o1Setter'; when BarBuilder (default constructor); then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void SimpleMerger.mergeRosetta(RosettaModelObjectBuilder, RosettaModelObjectBuilder, Consumer)"
  })
  void testMergeRosettaWithO1O2O1Setter_whenBarBuilder_thenDoesNotThrow() {
    // Arrange
    SimpleMerger simpleMerger = new SimpleMerger();
    BarBuilder barBuilder = new BarBuilder();
  ...
  @Test
  @DisplayName(
      "Test mergeRosetta(RosettaModelObjectBuilder, RosettaModelObjectBuilder, Consumer) with 'o1', 'o2', 'o1Setter'; when 'null'; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({
    "void SimpleMerger.mergeRosetta(RosettaModelObjectBuilder, RosettaModelObjectBuilder, Consumer)"
  })
  void testMergeRosettaWithO1O2O1Setter_whenNull_thenDoesNotThrow() {
    // Arrange
    SimpleMerger simpleMerger = new SimpleMerger();

    // Act and Assert
    assertDoesNotThrow(
        () -> simpleMerger.mergeRosetta(new BarBuilder(), null, mock(Consumer.class)));
  }
  ...
  void testMergeRosettaWithO1O2O1Setter_whenNull_thenDoesNotThrow2() {
    // Arrange, Act and Assert
    assertDoesNotThrow(() -> new SimpleMerger().mergeRosetta(null, null, mock(Consumer.class)));
  }
  ...
  @Test
  @DisplayName(
      "Test mergeBasic(Object, Object, Consumer, AttributeMeta[]) with 'o1', 'o2', 'o1Setter', 'metas'; when 'GLOBAL_KEY'; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void SimpleMerger.mergeBasic(Object, Object, Consumer, AttributeMeta[])"})
  void testMergeBasicWithO1O2O1SetterMetas_whenGlobalKey_thenDoesNotThrow() {
    // Arrange, Act and Assert
    assertDoesNotThrow(
        () ->
            new SimpleMerger()
  ...
  @Test
  @DisplayName(
      "Test mergeBasic(Object, Object, Consumer, AttributeMeta[]) with 'o1', 'o2', 'o1Setter', 'metas'; when 'null'; then does not throw")
  @Tag("ContributionFromDiffblue")
  @ManagedByDiffblue
  @MethodsUnderTest({"void SimpleMerger.mergeBasic(Object, Object, Consumer, AttributeMeta[])"})
  void testMergeBasicWithO1O2O1SetterMetas_whenNull_thenDoesNotThrow() {
    // Arrange, Act and Assert
    assertDoesNotThrow(
        () ->
            new SimpleMerger()
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void SimpleMerger.mergeBasic(Object, Object, Consumer, AttributeMeta[])"})
  void testMergeBasicWithO1O2O1SetterMetas_whenNull_thenDoesNotThrow2() {
    // Arrange, Act and Assert
    assertDoesNotThrow(
        () -> new SimpleMerger().mergeBasic(null, null, mock(Consumer.class), AttributeMeta.META));
  }
